...
const Addeditprojectgroup = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (
    ...
    } else if (!emailNotification && !whatsappNotification) {
      ...
      if (whatsappNotification) {
        ...
        const phoneNumbers = contactdetails.split(',').map((number) => number.trim());
...
export default Addeditprojectgroup;
