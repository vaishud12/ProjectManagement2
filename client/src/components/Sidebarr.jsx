...
export default function Sidebarr({ setExpanded }) {
                ...
                <SidebarContext.Provider value={{ expanded }}>
                    <ul className="flex-1 px-3">
                        ...
                        <SidebarItem
                            ...
                            text="Sector Master"
                            onClick={() => handleMenuItemClick("sectormaster")}
                        />
                        <SidebarItem
                            icon={<StickyNote size={20} />}
                            text="Project"
                            onClick={() => handleMenuItemClick("projectgroup")}
                        />
                        <SidebarItem
                            icon={<FaUser size={20} />}
                            text="Organization"
                            onClick={() => handleMenuItemClick("organizationmaster")}
                        />
                        <SidebarItem
                            icon={<Layers size={20} />}
                            text="Incident"
